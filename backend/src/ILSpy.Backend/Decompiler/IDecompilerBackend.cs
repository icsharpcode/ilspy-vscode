...
public interface IDecompilerBackend
{
    ...
    DecompileResult GetCode(string? assemblyPath, EntityHandle handle, string outputLanguage);
    ...
    CSharpDecompiler GetDecompiler(string assembly, string? outputLanguage = null);
}
